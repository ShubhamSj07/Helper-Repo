	...
	return (
		<>
			<div className={style['forgot-password-section']}>
				<div
					className={`${style['forgot-password-image']} ${style['child1']}`}
				>
					<img
				...
				<div
					className={`${style['forgot-password-form']} ${style['child2']}`}
				>
							...
							<React.Fragment>
								...
								<div className={style['inside-card']}>
									<p style={{ textAlign: 'center' }}>
										An invitation link has been sent on your
										registered email, please check your
										inbox for further steps.
									</p>
